...
SER_ENGINE = os.getenv("SER_ENGINE", "hf_wav2vec2").strip().lower()
...
TEXT_HF_MODEL_ZH = os.getenv("TEXT_HF_MODEL_ZH", "./training/text_models/zh_sentiment_exp03/best_model").strip()
