...
- `docs/defense_script.md`：答辩演示流程与故障兜底脚本。
...
- 每次跑完关键实验后，更新 `docs/experiments.md`，并执行 `python scripts/export_experiment_assets.py`。
- 论文写作前，先从 `docs/thesis_notes.md` 和 `docs/figures/` 补齐图表与术语。
